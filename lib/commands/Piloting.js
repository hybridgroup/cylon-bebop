...
module.exports = [
   ...
   *
   * @param {Boolean} flag flag to activate roll/pitch movement
   * @param {Number} roll Roll consign for the drone [-100;100]
   * @param {Number} pitch Pitch consign for the drone [-100;100]
   * @param {Number} yaw Yaw consign for the drone [-100;100]
   * @param {Number} gaz Gaz consign for the drone [-100;100]
